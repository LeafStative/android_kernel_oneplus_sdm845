 ...
 */
static KSU_SUSFS_DECL_FSNOTIFY_OPS(susfs_handle_sdcard_inode_event)
{
	if (!file_name || ksu_susfs_fname_len(file_name) != 7 ||
	    memcmp(ksu_susfs_fname_arg(file_name), "Android", 7))
		return 0;
